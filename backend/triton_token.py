...
class TritonRemoteModel:
    ...
    def __init__(self, url: str, endpoint: str = "", scheme: str = ""):
        ...
        if scheme == "http":
            ...
            config = self.triton_client.get_model_config(endpoint, headers=self.header)
        else:
    ...
    def __call__(self, *inputs: np.ndarray) -> List[np.ndarray]:
        ...
        outputs = self.triton_client.infer(model_name=self.endpoint, inputs=infer_inputs, outputs=infer_outputs, headers=self.header)
